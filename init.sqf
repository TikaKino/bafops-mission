...
null = ["AI Behaviours", "Autocombat Disable", { [_this select 1,"AUTOCOMBAT"] remoteExecCall ["disableAI",_this select 1]; }] call Ares_fnc_RegisterCustomModule;
...
null = ["SAR", "Start / Edit SAR Beacon", { [_this select 1] execVM "ares\ares_sar_start.sqf" }] call Ares_fnc_RegisterCustomModule;
null = ["SAR", "Stop SAR Beacon", { [_this select 1] execVM "ares\ares_sar_stop.sqf" }] call Ares_fnc_RegisterCustomModule;
null = ["SAR", "Set SAR Beacon Color", { [_this select 1] execVM "ares\ares_sar_edit.sqf" }] call Ares_fnc_RegisterCustomModule;